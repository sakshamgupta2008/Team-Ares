...
import {
  ...
  getDummyDetail, buildChatPayload, buildDiseaseData, C,
  ...
  return (
    <div style={{ position: "relative", height: "100%", width: "100%" }}>
      ...
      <div style={S.stateLabel}>
        <div style={{ fontSize: 8, color: "#7aa2c7", letterSpacing: "0.12em" }}>STATE VIEW</div>
        <div style={{ fontSize: 15, fontWeight: 800, color: "#e8f4ff", marginTop: 2 }}>
          {cfg.label}
        </div>
        <div style={{ fontSize: 9, color: "#a5c5e1", marginTop: 4 }}>
      ...
      {hovered && hovPct !== null && (
        <div style={{ ...S.hovTip, borderColor: `${hovColor}44` }}>
          ...
          <div style={{ fontSize: 9, color: "#7aa2c7", marginTop: 3 }}>Click for full analysis</div>
        </div>
      )}

      {/* Risk legend */}
      <div style={S.legend}>
        <div style={{ fontSize: 8, color: "#7aa2c7", marginBottom: 8, letterSpacing: "0.1em" }}>
          RISK LEVEL
        </div>
        {[
          ...
          <div key={label} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 5 }}>
            ...
            <span style={{ fontSize: 9, color: "#a5c5e1" }}>{label}</span>
          </div>
        ))}
      </div>
      ...
      {/* Hint */}
      {!overlay && (
        <div style={{ ...S.hint, color: "#a5c5e1" }}>◉ Click a district for full AI analysis</div>
      )}
...
const S = {
  stateLabel: {
    ...
    background: "rgba(3,6,9,0.9)", border: "1px solid #1a3a5c",
  ...
  legend: {
    ...
    background: "rgba(3,6,9,0.92)", border: "1px solid #1a3a5c",
