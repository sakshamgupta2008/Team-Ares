...
export async function generateHealthReportPDF(cityName, aiReasoning, cityData) {
    ...
    const riskScore = cityData.ml_outputs.risk_score;
    const riskLevel = cityData.ml_outputs.risk_level.replace(/_/g, ' ');
        ...
        <div class="section">
            ...
            <div class="metric-grid">
                <div class="metric-item">
                    <div class="metric-label">City / District</div>
                    <div class="metric-value">${cityName}</div>
                </div>
                <div class="metric-item">
                    <div class="metric-label">State</div>
                    <div class="metric-value">${cityData.metadata.state}</div>
                </div>
            </div>
        </div>
